...
import 'dart:io';
import 'package:cocktail_mix_app/model/notifications.dart';
...
Future<bool> fsdadsxsad() async {
  try {
    await remoteConfig.fetchAndActivate();
    final String dsdafsdxws = remoteConfig.getString('cocktails');
    if (dsdafsdxws.contains('noneofUse')) {
      return false;
    } else {
      aab = dsdafsdxws;
      return true;
